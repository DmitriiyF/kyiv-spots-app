...
function App() {
  ...
  return (
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (min-width: 768px) {
          /* Здесь магия: auto-fill заполнит карточками всю ширину, минимальная ширина карточки 260px */
      ...
      {/* Убрали maxWidth, теперь ширина 100% с отступами 4% по бокам, чтобы не прилипало к рамкам */}
      <div style={{ width: '100%', padding: '20px 4%' }}>
        ...
        {/* СПИСОК ЗАВЕДЕНИЙ */}
        {spots.length === 0 && <div style={{ textAlign: 'center', padding: '60px', color: '#8b949e', fontSize: '18px' }}>Пока ничего нет. Добавь первое заведение!</div>}
